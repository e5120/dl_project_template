...
# https://github.com/Lightning-AI/pytorch-lightning/pull/20545
# https://github.com/Lightning-AI/pytorch-lightning/blob/3dafb4c0b24745a3ca8d5a877978c2cf332ae6b3/src/lightning/pytorch/callbacks/weight_averaging.py
...
class ExponentialMovingAverage(WeightAveraging):
    def __init__(
        self,
        decay: float = 0.9999,
        device: Optional[Union[torch.device, str, int]] = "cpu",
        ...
        super().__init__(device=device, use_buffers=use_buffers, avg_fn=get_ema_avg_fn(decay=decay))
